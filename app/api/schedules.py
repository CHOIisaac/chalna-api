...
@router.get("/calendar/daily", response_model=List[DailySchedule], summary="일별 일정 조회", description="특정 날짜의 일정을 조회합니다.")
def get_daily_schedules(
    ...
    for schedule in schedules:
        schedule_summaries.append(ScheduleSummary(
            id=schedule.id,
...
@router.get("/calendar/weekly", response_model=WeeklySchedule, summary="주별 일정 조회", description="특정 주의 일정을 조회합니다.")
...
@router.get("/summary/stats", summary="일정 통계", description="사용자의 일정 통계를 조회합니다.")
